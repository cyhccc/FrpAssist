...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SwitchButton_t, stringdata0) + ofs), len 
...
void SwitchButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SwitchButton::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SwitchButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_SwitchButton.offsetsAndSize,
    qt_meta_data_SwitchButton,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SwitchButton_t
, QtPrivate::TypeAndForceComplete<SwitchButton, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<bool, std::false_type>
...
// SIGNAL 0
void SwitchButton::clicked(bool _t1)
{
